"""
Script to generate comparison plots showing original images with v3 and v26 predictions.
...
def create_three_way_comparison(original_path, v3_pred_path, v26_pred_path, output_path, image_name):
    ...
    # Add overall title
    fig.suptitle(f'Comparison: {image_name}', fontsize=18, fontweight='bold', y=0.98)
...
def generate_all_comparisons(base_dir="exps", output_dir="comparisons"):
    """
    Generate three-way comparison plots for all images.
    ...
    # List of test images
    image_files = [
        'cat.jpg', 'city_scene.jpg', 'dog.jpg', 'dog2.jpg', 
        'eagle.jpg', 'food.jpg', 'giraffe.jpg', 'horses.jpg',
        'motorbike.jpg', 'person.jpg', 'surf.jpg', 'wine.jpg'
    ]
    
    print("\n" + "="*60)
    print("GENERATING THREE-WAY COMPARISON PLOTS")
